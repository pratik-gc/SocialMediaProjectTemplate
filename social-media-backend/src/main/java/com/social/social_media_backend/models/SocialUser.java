...
public class SocialUser {
    ...
    @ManyToMany(fetch = FetchType.EAGER) //Default Fetch Type for @ManyToMany & @ OneToMany is Lazy
                                         //Default Fetch type for @OneToOne & @ManyToOne is Eager
                                         //Eager Fetch Type should be used only when it is needed bcz it will
                                         //have impact on performance of our application bcz of complex nature
                                         //of SQL queries that need to be generated by Hibernate and data to be loaded
    @JoinTable(
